...
import { EVENT_MAGIC_CELLAR,        FLOW_MAGIC_CELLAR        } from './magic-cellar.js';
import { EVENT_ANCIENT_BATTLEFIELD, FLOW_ANCIENT_BATTLEFIELD } from './ancient-battlefield.js';
...
export * from './magic-cellar.js';
export * from './ancient-battlefield.js';
...
export const ALL_EVENTS: ReadonlyArray<EventDefinition> = [
  ...
  EVENT_MAGIC_CELLAR, EVENT_ANCIENT_BATTLEFIELD,
];
...
export const ALL_FLOWS: ReadonlyArray<FlowDefinition> = [
  ...
  FLOW_MAGIC_CELLAR, FLOW_ANCIENT_BATTLEFIELD,
];
